...
public class EmailConstant {
    ...
    public static final String USERNAME = "yassinbenattig9@gmail.com";
    public static final String PASSWORD = "mifiveootgwrnzzv";
    public static final String FROM_EMAIL = "yassinbenattig9@gmail.com";
